export const data = [
  { company_name: 'Singapore Airlines', industry: 'Airline', stance: 'China' },
  { company_name: 'Malaysian Airlines', industry: 'Airline', stance: 'China' },
  { company_name: 'Garuda Indonesia', industry: 'Airline', stance: 'China' },
  { company_name: 'Vietnam Airlines', industry: 'Airline', stance: 'China' },
  { company_name: 'Philippine Airlines', industry: 'Airline', stance: 'China' },
  { company_name: 'Thai Airways', industry: 'Airline', stance: 'China' },
  {
    company_name: 'Jetstar (under Qantas)',
    industry: 'Airline',
    stance: 'China'
  },
  { company_name: 'Scoot', industry: 'Airline', stance: 'China' },
  { company_name: 'Cathay Pacific', industry: 'Airline', stance: 'China' },
  { company_name: 'Cebu Pacific Air', industry: 'Airline', stance: 'China' },
  { company_name: 'British Airways', industry: 'Airline', stance: 'China' },
  { company_name: 'Turkish Airlines', industry: 'Airline', stance: 'China' },
  { company_name: 'Air Canada', industry: 'Airline', stance: 'China' },
  { company_name: 'Eva Air', industry: 'Airline', stance: 'Taiwan' },
  { company_name: 'Qantas', industry: 'Airline', stance: 'China' },
